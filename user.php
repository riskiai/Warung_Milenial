  ...
  <!-- Menu -->    
      <div class="container">
        <div class="judul text-center mt-5">
          <h3 class="font-weight-bold">WARUNG MILENIAL</h3>
          <h5>Margdadi, Indramayu, Jawa Barat
          <br>Buka Jam <strong>15:00 - 24:00</strong></h5>
        </div>

        <div class="row mb-5 mt-5 gambar ">
          <div class="col-md-6 d-flex justify-content-end">
            <div class="card text-white border-light">
              <img src="images/produk6.jpg" class="card-img" alt="Lihat Daftar Menu">
              <div class="card-img-overlay mt-5 text-center">
               <a href="menu_pembeli.php" class="btn warna3 text-light">LIHAT DAFTAR MENU</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 d-flex justify-content-start">
            <div class="card text-white border-light">
              <img src="images/makanan3.jpg" class="card-img" alt="Lihat Pesanan">
              <div class="card-img-overlay mt-5 text-center">
               <a href="pesanan_pembeli.php" class="btn warna3 text-light">LIHAT PESANAN</a>
              </div>
            </div>
          </div>
        </div>
